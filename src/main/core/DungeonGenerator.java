...
public abstract class DungeonGenerator {
	...
	/**
	 * @return an two dimensional array if Constants.DUNGEON_SIZE in both
	 ...
	 * Adds a two dimensional array of floats each at length
	 * Constants.DUNGEON_SIZE to the BlockedQueue provided by DungeonGenerator
